public class Test2 {
	...
	public static void main(String[] args) {
		...
		for (int iii = 0; iii < m; iii++) // házi! : btömb.length függvényt használva -m- helyett milyen értékeket ad
		...
		System.out
				...
				m = j; //A "b" tÃ¶mb elemeinek szÃ¡ma
				int l = k; //A "c" tÃ¶mb elemeinek szÃ¡ma
		 
				//ElsÅ‘ tÃ¶mb kiÃ­ratva:
				for(i=0; i<n;i++)
					System.out.print(a[i] + " ");
				System.out.println();
		 
				//MÃ¡sodik tÃ¶mb kiÃ­ratva:
				for(i=0; i<m;i++)
					System.out.print(b[i] + " ");
				System.out.println();
		 
				//Harmadik tÃ¶mb kiÃ­ratva:
				for(i=0; i<l;i++)
				...
				int[] d = {4, 7, 9, 8, 2};					//	int[] a = {3, 8, 2, 4, 5, 1, 6};
				...
				System.out
						.println("UniÃ³ tÃ©tel\n-----------------------------------------------");
				n = 7; // Az elsÅ‘ tÃ¶mb elemeinek szÃ¡ma
				m = 5; //A mÃ¡sodik tÃ¶mb elemeinek szÃ¡ma
				c = new int[n+m]; //A harmadik tÃ¶mb
				...
				l = k + 1; //A "c" tÃ¶mb elemeinek szÃ¡ma
				...
				// tÃ©tel2--------------------------------------------------------------
				System.out
						.println("BuborÃ©k rendezÃ©s tÃ©tel2\n-----------------------------------------------");
				...
				// RendezÃ©s beszurÃ¡ssal
				// tÃ©tel--------------------------------------------------------------
				System.out
						.println("RendezÃ©s beszÃºrÃ¡ssal tÃ©tel\n-----------------------------------------------");
				...
				// tÃ©tel--------------------------------------------------------------
				System.out
						.println("Ã–sszefÃ©sÃ¼lÃ©s tÃ©tel\n-----------------------------------------------");
		        int[] z = { 1, 3, 5, 7, 9};
				int[] x = {2, 4, 6, 8 };
	...
	//NormÃ¡l megoldÃ¡s a rendezÃ©s beszurÃ¡ssal tÃ©telre
