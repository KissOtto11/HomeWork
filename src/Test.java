...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        int i = 0;
        char c = copyFromMe.charAt(i); /*kimásoljuk az adott karakter értékét*/
        ...
        System.out.println("Ez volt a while ciklus!\n");
        
        copyToMe = new StringBuffer(); /* a copyToMe változó nullázása */
        ...
        System.out.println(copyToMe);
        System.out.println("Ez volt a do-while ciklus!\n");
        ...
        /*// órai gyakorlat oszható 3-mal maradék nélkül
       
        boolean oszthatoHarommal = false;
        boolean oszthatoKettovel = false;
        
        
        if (testscore % 3 == 0) 
        	oszthatoHarommal = true;
        	
        if (testscore % 2== 0) 
            oszthatoKettovel = true;
        
        System.out.println("Hárommal osztható " + oszthatoHarommal+ "Osztható kettõvel " + oszthatoKettovel);
        ...
        System.out.println("The character " + aChar + " is "
                + (Character.isUpperCase(aChar) ? "upper" : "lower") + "case."); //  If szerkezet ? "igaz" : "hamis" -ág
        ...
        System.out.println("\nswitch-case szerkezet nap/hó/szökõév ellenõrzés \n");
        month = 2;
        int year = 2000;
        int numDays = 0;
        switch (month) {
        ...
        System.out.println("\nswitch-case szerkezet nap/hó/szökõév ellenõrzés detto az elõzõ a month osztályt felhasználva \n");
        ...
        // break
        System.out.println("feltétel nélküli vezérlésátadás :");
